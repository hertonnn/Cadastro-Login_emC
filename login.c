...
void cadastro()
{
    ...
    Cadastros = fopen("cadastros.dat", "ab"); // cria um arquivo binário para gravação ou apenas altera um existente

    if (Cadastros == NULL) // Caso não consiga abrir o arquivo
    {
...
int verifica_Login(char senha[], char nome[])
{
    ...
    // função verifica se usuario está no documento e senha está correta 
    // retorno 0 = usuario e senha corretos
    // retorno 10 = apenas usario está correto e senha incorreta
